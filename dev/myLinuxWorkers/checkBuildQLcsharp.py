...
def checkBuildQL(hashP,urlP):
    ...
    os.system("timeout 40m /opt/codeqlmy/codeql/codeql database create --language=csharp --source-root="+foldTP+" --logdir="+foldLogTP+" -- "+foldPrjTP+" &&sudo echo $? > "+fileExitCodeTP)
